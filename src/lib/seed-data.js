export const PRODUCT_IMAGES = {
  ...
  "Home Jersey 24/25": "https://images.pexels.com/photos/1661338/pexels-photo-1661338.jpeg?auto=compress&cs=tinysrgb&w=300",
  "Club Mug": "https://images.pexels.com/photos/1209462/pexels-photo-1209462.jpeg?auto=compress&cs=tinysrgb&w=300",
  ...
  "Training Top": "https://images.pexels.com/photos/1311523/pexels-photo-1311523.jpeg?auto=compress&cs=tinysrgb&w=300",
  ...
  "Signed Photo Frame": "https://images.pexels.com/photos/918778/pexels-photo-918778.jpeg?auto=compress&cs=tinysrgb&w=300",
  ...
  "Stadium Flag": "https://images.pexels.com/photos/46798/the-ball-stadion-football-the-pitch-46798.jpeg?auto=compress&cs=tinysrgb&w=300",
  "Mini Trophy Replica": "https://images.pexels.com/photos/1884577/pexels-photo-1884577.jpeg?auto=compress&cs=tinysrgb&w=300",
  "Water Bottle": "https://images.pexels.com/photos/1346197/pexels-photo-1346197.jpeg?auto=compress&cs=tinysrgb&w=300",
  "Keyring": "https://images.pexels.com/photos/1191090/pexels-photo-1191090.jpeg?auto=compress&cs=tinysrgb&w=300",
  "Retro Badge Pin": "https://images.pexels.com/photos/1884577/pexels-photo-1884577.jpeg?auto=compress&cs=tinysrgb&w=300",
  "t_shirt": "https://images.pexels.com/photos/428338/pexels-photo-428338.jpeg?auto=compress&cs=tinysrgb&w=300",
  "Evening Midi Dress": "https://images.pexels.com/photos/985287/pexels-photo-985287.jpeg?auto=compress&cs=tinysrgb&w=300",
  "Summer Floral Dress": "https://images.pexels.com/photos/1485031/pexels-photo-1485031.jpeg?auto=compress&cs=tinysrgb&w=300",
  "Office Shift Dress": "https://images.pexels.com/photos/1036623/pexels-photo-1036623.jpeg?auto=compress&cs=tinysrgb&w=300",
  "Casual Denim Dress": "https://images.pexels.com/photos/1346187/pexels-photo-1346187.jpeg?auto=compress&cs=tinysrgb&w=300",
  "Maxi Boho Dress": "https://images.pexels.com/photos/1755385/pexels-photo-1755385.jpeg?auto=compress&cs=tinysrgb&w=300",
  "Bodycon Cocktail Dress": "https://images.pexels.com/photos/1536619/pexels-photo-1536619.jpeg?auto=compress&cs=tinysrgb&w=300",
  "Linen Shirt Dress": "https://images.pexels.com/photos/1055691/pexels-photo-1055691.jpeg?auto=compress&cs=tinysrgb&w=300",
  "Wrap Dress Classic": "https://images.pexels.com/photos/1181686/pexels-photo-1181686.jpeg?auto=compress&cs=tinysrgb&w=300",
  "Kids Party Dress": "https://images.pexels.com/photos/1620760/pexels-photo-1620760.jpeg?auto=compress&cs=tinysrgb&w=300",
  "Bridesmaid Dress": "https://images.pexels.com/photos/291759/pexels-photo-291759.jpeg?auto=compress&cs=tinysrgb&w=300",
};
...
export const INITIAL_PRODUCTS = [
  ...
  /* Dresses — full attributes: brand, stock (qty), Size / Color / Material via dynamic_attributes + sizes/colors */
  { id: 15, name: "Evening Midi Dress", sku: "DRS-EVN-01", barcode: "5051000000015", category: "Dresses", price: 72.99, stock: 48, emoji: "👗", featured: true, returnable: true, taxPct: 20, brand: "Luna Atelier", discount: 0, description: "Elegant midi length with subtle sheen. Lined bodice, concealed back zip.", care: "Dry clean only", sizes: ["XS", "S", "M", "L", "XL"], colors: ["Black", "Navy", "Burgundy"], material: "Shell: 92% Polyester, 8% Elastane · Lining: 100% Polyester", dynamic_attributes: { Size: ["XS", "S", "M", "L", "XL"], Color: ["Black", "Navy", "Burgundy"], Material: ["Satin blend (listed)", "Crepe blend"] } },
  { id: 16, name: "Summer Floral Dress", sku: "DRS-FLR-02", barcode: "5051000000016", category: "Dresses", price: 54.5, stock: 62, emoji: "🌸", featured: true, returnable: true, taxPct: 20, brand: "Bloom & Thread", discount: 0, description: "Lightweight floral print, adjustable straps, tiered skirt.", care: "Machine wash 30°C", sizes: ["XS", "S", "M", "L", "XL", "XXL"], colors: ["Coral", "Sky Blue", "White"], material: "100% Viscose", dynamic_attributes: { Size: ["XS", "S", "M", "L", "XL", "XXL"], Color: ["Coral", "Sky Blue", "White"], Material: ["Viscose", "Organic cotton poplin"] } },
  { id: 17, name: "Office Shift Dress", sku: "DRS-OFF-03", barcode: "5051000000017", category: "Dresses", price: 64.0, stock: 35, emoji: "💼", featured: false, returnable: true, taxPct: 20, brand: "Nine-to-Five", discount: 0, description: "Structured shift with side pockets, knee length, wrinkle-resistant.", care: "Machine wash 40°C", sizes: ["XS", "S", "M", "L", "XL"], colors: ["Charcoal", "Camel", "Black"], material: "68% Polyester, 29% Viscose, 3% Elastane", dynamic_attributes: { Size: ["XS", "S", "M", "L", "XL"], Color: ["Charcoal", "Camel", "Black"], Material: ["Stretch suiting", "Ponte knit"] } },
  { id: 18, name: "Casual Denim Dress", sku: "DRS-DNM-04", barcode: "5051000000018", category: "Dresses", price: 49.99, stock: 55, emoji: "👖", featured: true, returnable: true, taxPct: 20, brand: "Denim Lane", discount: 0, description: "Classic shirt-dress cut in mid-weight denim, belt included.", care: "Machine wash cold", sizes: ["XS", "S", "M", "L", "XL", "XXL"], colors: ["Indigo", "Light Blue", "Black"], material: "98% Cotton, 2% Elastane", dynamic_attributes: { Size: ["XS", "S", "M", "L", "XL", "XXL"], Color: ["Indigo", "Light Blue", "Black"], Material: ["Stretch denim", "Rigid denim"] } },
  { id: 19, name: "Maxi Boho Dress", sku: "DRS-BOH-05", barcode: "5051000000019", category: "Dresses", price: 58.75, stock: 40, emoji: "🌿", featured: false, returnable: true, taxPct: 20, brand: "Wanderlust", discount: 0, description: "Flowing maxi with smocked bodice and flutter sleeves.", care: "Machine wash 30°C", sizes: ["S", "M", "L", "XL"], colors: ["Olive", "Rust", "Cream"], material: "100% Rayon", dynamic_attributes: { Size: ["S", "M", "L", "XL"], Color: ["Olive", "Rust", "Cream"], Material: ["Rayon crepe", "Viscose challis"] } },
  { id: 20, name: "Bodycon Cocktail Dress", sku: "DRS-CT-06", barcode: "5051000000020", category: "Dresses", price: 69.0, stock: 28, emoji: "✨", featured: true, returnable: true, taxPct: 20, brand: "After Eight", discount: 0, description: "Figure-hugging cocktail length, ruched side seam.", care: "Hand wash cold", sizes: ["XS", "S", "M", "L", "XL"], colors: ["Ruby", "Emerald", "Black"], material: "90% Polyester, 10% Spandex", dynamic_attributes: { Size: ["XS", "S", "M", "L", "XL"], Color: ["Ruby", "Emerald", "Black"], Material: ["Jersey knit", "Scuba"] } },
  { id: 21, name: "Linen Shirt Dress", sku: "DRS-LIN-07", barcode: "5051000000021", category: "Dresses", price: 61.5, stock: 33, emoji: "🌾", featured: false, returnable: true, taxPct: 20, brand: "Coastal Linen Co.", discount: 0, description: "Breathable linen blend, button front, roll-tab sleeves.", care: "Machine wash 30°C, reshape while damp", sizes: ["XS", "S", "M", "L", "XL", "XXL"], colors: ["Natural", "White", "Soft Blue"], material: "55% Linen, 45% Cotton", dynamic_attributes: { Size: ["XS", "S", "M", "L", "XL", "XXL"], Color: ["Natural", "White", "Soft Blue"], Material: ["Linen-cotton", "Pure linen"] } },
  { id: 22, name: "Wrap Dress Classic", sku: "DRS-WRP-08", barcode: "5051000000022", category: "Dresses", price: 56.25, stock: 44, emoji: "🎀", featured: true, returnable: true, taxPct: 20, brand: "Silhouette", discount: 0, description: "True wrap closure, tie waist, knee length.", care: "Machine wash 30°C", sizes: ["XS", "S", "M", "L", "XL"], colors: ["Navy Dot", "Red", "Black"], material: "95% Polyester, 5% Elastane", dynamic_attributes: { Size: ["XS", "S", "M", "L", "XL"], Color: ["Navy Dot", "Red", "Black"], Material: ["ITY knit", "Matte jersey"] } },
  { id: 23, name: "Kids Party Dress", sku: "DRS-KID-09", barcode: "5051000000023", category: "Dresses", price: 32.99, stock: 70, emoji: "🎈", featured: false, returnable: true, taxPct: 20, brand: "Little Sparkle", discount: 0, description: "Party dress with tulle skirt, soft cotton bodice, glitter trim.", care: "Machine wash 30°C inside out", sizes: ["4Y", "5Y", "6Y", "7Y", "8Y", "10Y", "12Y"], colors: ["Pink", "Lilac", "Gold"], material: "Bodice: 100% Cotton · Skirt: Polyester tulle", dynamic_attributes: { Size: ["4Y", "5Y", "6Y", "7Y", "8Y", "10Y", "12Y"], Color: ["Pink", "Lilac", "Gold"], Material: ["Cotton + tulle", "Satin + tulle"] } },
  { id: 24, name: "Bridesmaid Dress", sku: "DRS-BRD-10", barcode: "5051000000024", category: "Dresses", price: 95.0, stock: 22, emoji: "💐", featured: true, returnable: true, taxPct: 20, brand: "Vow Studio", discount: 0, description: "Floor-length chiffon overlay, padded cups, invisible zip.", care: "Dry clean recommended", sizes: ["XS", "S", "M", "L", "XL", "XXL"], colors: ["Dusty Rose", "Sage", "Champagne"], material: "Shell: 100% Polyester chiffon · Lining: 100% Polyester", dynamic_attributes: { Size: ["XS", "S", "M", "L", "XL", "XXL"], Color: ["Dusty Rose", "Sage", "Champagne"], Material: ["Chiffon", "Soft satin"] } },
];
...
export const INITIAL_ORDERS = [
  ...
  { id: "ORD-PKUP-001", customerId: 5, customerName: "Taylor Smith", cashierId: null, cashierName: "Online", items: [{ productId: 1, name: "Home Jersey 2024", qty: 1, price: 89.99, discount: 0 }], subtotal: 89.99, tax: 18.00, total: 107.99, payment: "Online", date: "2024-03-18 10:00", counter: "Online", status: "pending", orderType: "pickup" },
  { id: "ORD-PKUP-002", customerId: 6, customerName: "Chris Johnson", cashierId: null, cashierName: "Online", items: [{ productId: 4, name: "Training Jacket", qty: 1, price: 64.99, discount: 0 }], subtotal: 64.99, tax: 13.00, total: 77.99, payment: "Online", date: "2024-03-18 11:00", counter: "Online", status: "picked-up", orderType: "pickup", pickedUpAt: "2024-03-18 11:30", pickedUpBy: "Staff Alex" },
];
...
export const CATEGORIES = ["All", "Jerseys", "Training Wear", "Fan Accessories", "Football Equipment", "Collectibles", "Dresses"];
